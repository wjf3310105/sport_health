...
void simple_aes(void)
{
    ...
    printf_string( sBlock, ARRAY_LEN(sBlock) );   //打印加密结果:50 fe 67 cc 99 6d 32 b6 da 09 37 e9 9b af ec 60

    //解密
    osel_memcpy( aBlock, sBlock , size );
    aes_decrypt( aBlock, sBlock, &AesContext );
    printf_string( sBlock, ARRAY_LEN(sBlock) );   //打印解密结果:00 01 02 03 04 05 06 07 08 09 0a 0b 0c 0d 0e 0f
}
