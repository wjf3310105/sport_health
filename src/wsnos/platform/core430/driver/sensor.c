...
#define I2C_WRITE_START() 					        \
                do                                              \
                    {                                               \
                        WHILE(UCB3CTL1 & UCTXSTP,10000,FALSE);	    \
                            UCB3CTL1 |= UCTR;							\
                                UCB3CTL1 |= UCTXSTT;						\
                    } while(__LINE__ == -1)
...
#define I2C_WAIT_ADDR_ACK()						    \
                            {												\
                                WHILE(UCB3CTL1 & UCTXSTT,10000,FALSE);	    \
                            }
...
do                                              \
    {                                               \
        WHILE(!(UCB3IFG & UCTXIFG),10000,FALSE);    \
            UCB3TXBUF = (x);							\
    } while(__LINE__ == -1)
...
#define I2C_RECCEIVE_CHAR(x)                        \
        do                                              \
            {                                               \
		WHILE(!(UCB3IFG & UCRXIFG),10000,FALSE);	\
                    (x) = UCB3RXBUF;							\
            } while(__LINE__ == -1)
