...
#define INFO_BIND_ADDR  0x4000u   //*< used for store BIND-ID info
#define INFO_ADDR_ADDR  0x5000u


#define DEVICE_INFO_ADDR                (INFO_B_ADDR)
#define DEVICE_OPERATE_MODE_FLAG_ADDR   (INFO_D_ADDR)

#define FLASH_SEG_ERASE 0
#define FLASH_BK_ERASE  1

#define FLASH_PAGE_SIZE                 (512u)
#define FLASH_INFO_SIZE                 (128u)
